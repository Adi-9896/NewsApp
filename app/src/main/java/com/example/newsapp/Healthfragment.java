...
public class Healthfragment extends Fragment {
    ...
    RecyclerView recyclerViewhealh;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        recyclerViewhealh =  view.findViewById(R.id.recyclerviewofhealth);
        modalArrayList =  new ArrayList<>();
        recyclerViewhealh.setLayoutManager(new LinearLayoutManager(getContext()));
        adapter =new Adapter(getContext(),modalArrayList);
        recyclerViewhealh.setAdapter(adapter);
        findnews();
